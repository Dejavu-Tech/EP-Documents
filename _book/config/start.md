...
## 关于吃货星球 <span id="gy"></span>

吃货星球微信小程序基于Thinkphp开发的多功能电商快速开发平台，整合bootstrap、Vue、Redis等技术，并提供基于Node.js开发的移动端APP、桌面端web及支付宝、头条、抖音小程序等全端客户端，为中小型企业及个人实现极速优质的电商应用和数字化运营管理。
...
* 全端开发
  ...
  新版将支持IOS、Android、H5、各平台小程序（微信/支付宝/百度/头条/QQ/钉钉/淘宝）一套代码搞定多端应用程序
...
| PHP           | 7.1 | https://www.php.net/                        |全世界最好的语言？ |
...
| 技术                 | 说明                | 官网                                                         |
| -------------------- | ------------------- | ------------------------------------------------------------ |
| thinkPHP       | 小程序后端开发框架        | [http://www.thinkphp.cn/](http://www.thinkphp.cn/) |
| Node.js      | web及应用端开发框架        | [http://www.thinkphp.cn/](http://www.thinkphp.cn/) |
...
| EP-App-UI  | EP多端UI组件库            | [https://github.com/Dejavu-Tech/EP-App-UI/](https://github.com/Dejavu-Tech/EP-App-UI/) |
### 数据服务层
| 技术                 | 说明                | 官网                                                         |
| -------------------- | ------------------- | ------------------------------------------------------------ |
...
| Pure-Ftpd | 1.0.49 | https://www.phpmyadmin.net/ |
| phpMyAdmin | 4.8 | http://pureftpd.sourceforge.net/ |
...
| 单用户商用版 | 提供全功能电商模块 | ✔️ |200元|1000元/年| 2800元，新版前端4080元 |[购买地址](https://www.ch871.com) |
| 多用户商用版 | 提供全功能电商模块 | ✔️ |100元|1000元/年| 3800元，新版前端5080元 |[购买地址](https://www.ch871.com) |
| 二次开发授权 | 提供全功能电商模块及基础版前端 | ✔️ | - | - | 电询议价 | [详询作者](https://github.com/Dejavu-Tech/EP-WechatApp) |

> 免费版：请遵循GPL v3.0开源协议（不得闭源），不可商用。未遵循开源协议商用者，一经发现后果自负。

> 二次开发按照合同约定授权于以下场景：开发基于吃货星球的面向大众如服务收费的网站或应用程序，或非大众如企业内部的特定网站或应用程序或用于项目投标，并于合同限定商用次数，吃货星球受国家计算机软件著作权保护，违者必追究法律责任。

###  演示版 

[后台](https://demo.ch871.com/)

[前端](https://yun-1256050155.cos.ap-beijing.myqcloud.com/ssr/ssr-mac.dmg)

[新版前端](https://yun-1256050155.cos.ap-beijing.myqcloud.com/ssr/ssr-mac.dmg)

> 演示版后台及小程序前端提供多用户版，不定期更新测试版功能，并非最终版本。
...
> [点击此处下载](https://yun-1256050155.cos.ap-beijing.myqcloud.com/ssr/ssr-mac.dmg)

## 官网 <span id="gw"></span>
[蒂佳芙科技官方网站](https://www.dejavu871.com/)

[吃货星球网站（更新中）](https://www.ch871.com/)

## 关于本文档 <span id="gybwd"></span>
* 文档内容适用于微信小程序V3.6以上版本客户端，V3.6以下可能会因为功能调整及升级导致无法检索，请尽快升级或联系客服。
* 购买快速部署的客户可跳过下一章准备工作，直接开始运营业务。如客户不具备服务器基础技术或无技术人员建议购买快速部署服务。
* 文档中的<button>多商户</button>、<code>V4.0.3</code>等标记为标记中版本特有功能或权限，其他版本或更低版本请选择跳过。
* 本文档某些内容为付费内容，商用客户请联系客服免费解锁。
* 本文档在新的稳定版本发布之时同步更新，更新时间恕不另行通知。
* 本文档遵循《吃货星球软件许可协议》，禁止商业性转载。